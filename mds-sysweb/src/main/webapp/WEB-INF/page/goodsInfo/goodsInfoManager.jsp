            ...
            <div style="margin-top: 10px;">
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
                    ...
                    <div class="layui-input-inline">
                        <input id="goodscode" type="text" name="goodscode" placeholder="请输入物品编号" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
                    <label class="layui-form-label">物品名称</label>
                    <div class="layui-input-inline">
                        <input id="goodsname" type="text" name="goodsname" placeholder="请输入物品名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
...
<script type="text/javascript">
    ;!function(){
        ...
        var dataTableObj = table.render({
            ...
            height: 'full-200',
            method:'post',
            url:'${basepath}/goodsinfo/getGoodsInfoList.do',
            cellMinWidth: 80, //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            cols: [[
                {type:'checkbox'},
                {type:'numbers',title: '序号'},
                /*{field:'id', width:80, title: 'ID', align:'center'},*/
                {field:'goodscode', width:150, title: '物品编号', align:'center'},
        ...
        $('#addBtn').on('click', function(){
            layer.open({
                ...
                area : ['800px' , '520px'],
                content: '${basepath}/goodsinfo/toOperatorGoodsInfoPage.do'
            });
        });
        ...
        $("#deleteBtn").on('click', function(){
            ...
            layer.msg('确定要删除此数据？', {
                ...
                ,yes: function(index){
                    layer.close(index);
                    $.ajax({
                        url:"${basepath}/goodsinfo/toDeleteGoodsInfoPage.do",
                        type:"POST",
                        async:false,
                        data:{ids:ids},
                        dataType:"json",
