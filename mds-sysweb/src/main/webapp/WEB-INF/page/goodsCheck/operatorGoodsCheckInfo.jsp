...
<div style="padding: 0px 50px;padding-top: 20px;">
    <form id="dateForm" class="layui-form layui-form-pane" action="/goodsCheck/operatorGoodsCheck.do">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="carriershape" placeholder="请输入载体形状" class="layui-input" lay-verify="required" value="${goodsinfo.carriershape}">
            </div>
        </div>
        <%--蜂窝形状--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="honeycombshape" placeholder="请输入蜂窝形状" class="layui-input" lay-verify="required" value="${goodsinfo.honeycombshape}">
            </div>
        </div>
        <%--净重--%>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="netweight" placeholder="请输入净重" class="layui-input" lay-verify="required" value="${goodsinfo.netweight}">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="elcontent" placeholder="请输入含量" class="layui-input" lay-verify="required" value="${goodsinfo.netweight}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">元素名称</label>
