...
<div class="wrapper wrapper-content animated fadeInUp" style="margin-left: 10px;">
            ...
            <div style="margin-top: 10px;">
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
                    ...
                    <div class="layui-input-inline">
                        <input id="username_id" type="text" name="username" placeholder="请输入用户名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
                    <label class="layui-form-label">用户昵称</label>
                    <div class="layui-input-inline">
                        <input id="netname_id" type="text" name="netname" placeholder="请输入用户昵称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="width: 310px;float:left;clear: none;">
    ...
    <div class="data-part">
        ...
        <table class="layui-hide" id="userTable_id"></table>
    </div>
</div>
</body>
...
<script type="text/javascript">
    ;!function(){
        ...
        var dataTableObj = table.render({
            ...
            height: 'full-200',
            method:'post',
            url:'${basepath}/userManager/toUserManagerList.do',
            cellMinWidth: 80, //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            cols: [[
                {type:'checkbox'},
                {type:'numbers',title: '序号'},
                /*{field:'id', width:80, title: 'ID', align:'center'},*/
                {field:'username', width:150, title: '用户名称', align:'center'},
                {field:'netname', width:150, title: '用户昵称', align:'center'},
        ...
        $('#addBtn').on('click', function(){
            layer.open({
                ...
                area : ['800px' , '520px'],
                content: '${basepath}/userManager/toAddUser.do'
            });
        });

        //修改物品信息
        $('#updateBtn').on('click', function(){
            var checkStatus = table.checkStatus('usertable'); //test即为基础参数id对应的值
            ...
            layer.open({
                ...
                shadeClose: false, //点击遮罩关闭层
                area : ['800px' , '520px'],
                content: '${basepath}/userManager/toAddUser.do?id='+checkStatus.data[0].id
            });
        });
        ...
        $("#deleteBtn").on('click', function(){
            ...
            layer.msg('确定要删除此数据？', {
                ...
                ,yes: function(index){
                    layer.close(index);
                    $.ajax({
                        url:"${basepath}/userManager/toDeleteUser.do",
                        type:"POST",
                        async:false,
                        data:{ids:ids},
                        dataType:"json",
